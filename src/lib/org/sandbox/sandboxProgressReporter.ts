...
export class SandboxProgressReporter {
    ...
    public static logSandboxProcessResult(ux: UX, processRecord: SandboxProcessObject, sandboxRes: SandboxUserAuthResponse): void {
        if (processRecord){
    ...
    public static logSandboxProgress(ux: UX, processRecord: SandboxProcessObject, pollIntervalInSecond: number, retriesLeft : number, waitingOnAuth: boolean) {
