...
export class FileKeyValueStore {
   ...
   */
  setValues(newAliases: any, group = 'default'): Promise<any> {
    return srcDevUtil
   ...
   */
  delete(alias: string, group = 'default'): Promise<any> {
   ...
   */
  set(alias: string, property: string | number, group = 'default'): Promise<any> {
    return srcDevUtil
      .getGlobalConfig(this.fileStoreName, {})
   ...
   */
  unset(aliasesToUnset: string[], group = 'default'): Promise<any> {
    return srcDevUtil
      .getGlobalConfig(this.fileStoreName, {})
      .then((aliases) => {
   ...
   */
  get(alias: string, group = 'default') {
   ...
   */
  list(group = 'default'): Promise<any> {
   ...
   * @returns {Promise} The promise resolved when the alias is retrieved
   */
  byValue(value: string | number, group = 'default'): Promise<any> {
