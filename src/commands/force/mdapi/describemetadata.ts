...
export class MdapiDescribemetadataCommand extends ToolbeltCommand {
  ...
  public static readonly flagsConfig: FlagsConfig = {
    apiversion: flags.builtin({
      ...
      char: 'a',
      description: messages.getMessage('mdDescribeMetadataCommandCliApiVersion'),
      longDescription: messages.getMessage('mdDescribeMetadataCommandCliApiVersionLong'),
    }),
  ...
  public async run(): Promise<unknown> {
    ...
    const MdapiDescribemetadataCommandImpl = require('../../../lib/mdapi/mdapiDescribemetadataCommand');
    return this.execLegacyCommand(new MdapiDescribemetadataCommandImpl(context), context);
  }
}
