    ...
    public async run(): Promise<unknown> {
        ...
        if (this.flags.type === OrgTypes.Sandbox) {
            ...
            sandboxOrg.on(SandboxEventNames.EVENT_STATUS, results => {
                SandboxProgressReporter.logSandboxProgress(this.ux, results.sandboxProcessObj, results.interval, results.retries, results.waitingOnAuth);
            });
            ...
            if(srcSandboxName){
                ...
                throw SfdxError.create(new SfdxErrorConfig(
                        'salesforce-alm',
                         'org_clone',
            ...
            throw SfdxError.create(new SfdxErrorConfig(
                'salesforce-alm',
                'org_clone',
                'commandOrganizationTypeNotSupport', [OrgTypes.Sandbox])
